      ...
      def client(oauth_provider)
        ...
        when 'Keycloak'
          OAuth2::Client.new(
            ...
            Redmine::Ciphering.decrypt_text(oauth_provider.client_secret),
            site: site,
            authorize_url: "#{oauth_provider.oauth_path}/realms/#{oauth_provider.tenant_id}/protocol/openid-connect/auth",
            token_url: "#{oauth_provider.oauth_path}/realms/#{RedmineOauth.tenant_id}/protocol/openid-connect/token"
          )
        when 'Okta'
          OAuth2::Client.new(
            oauth_provider.client_id,
